...
bundle-android:
	mkdir -p dist/bundles
	yarn react-native bundle --platform android --bundle-output dist/bundles/bundle-android.js --dev false --entry-file index.tsx --assets-dest libraries/android/library
